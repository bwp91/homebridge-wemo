...
module.exports = class deviceMakerGarage {
  constructor (platform, accessory) {
    ...
    this.service.updateCharacteristic(
      ...
      this.accessory.content.cacheLastTargetState
    )
  ...
  async internalStateUpdate (value) {
    ...
    try {
      ...
      this.accessory.content.cacheLastTargetState = value
      ...
      setTimeout(() => {
        ...
        this.accessory.content.cacheLastTargetState = prevTarg
      }, 2000)
  ...
  externalStateUpdate () {
    try {
      ...
      this.accessory.content.cacheLastTargetState = state
    ...
    try {
      ...
      if (target === 0) {
        ...
        if (value === 0) {
          ...
          this.accessory.content.cacheLastTargetState = this.gStates.Closed
        ...
        if (value === 1) {
          ...
          this.accessory.content.cacheLastTargetState = this.gStates.Open
          this.accessory.eveService.addEntry({ status: 0 })
          this.service.updateCharacteristic(
            this.eveChar.LastActivation,
            Math.round(new Date().valueOf() / 1000) - this.accessory.eveService.getInitialTime()
  ...
  async setDoorMoving (targetDoorState, homekitTriggered) {
    ...
    if (this.isMoving) {
      ...
      this.accessory.content.cacheLastTargetState = target
      return
    }
