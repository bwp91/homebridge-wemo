...
module.exports = class deviceLinkHub {
  ...
  async sendDeviceUpdate (deviceId, capability, value) {
    ...
    // Send the update
    return await this.client.sendRequest('urn:Belkin:service:bridge:1', 'SetDeviceStatus', {
      DeviceStatusList: { '#text': deviceStatusList }
    })
  }

  async requestDeviceUpdate (deviceId) {
    return await this.client.sendRequest('urn:Belkin:service:bridge:1', 'GetDeviceStatus', {
      DeviceIDs: deviceId
    })
  }
}
