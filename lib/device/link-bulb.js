...
module.exports = class deviceLinkBulb {
  constructor (platform, priAcc, accessory) {
    ...
    this.enableColour = deviceConf.enableColour
    this.alShift =
      deviceConf.adaptiveLightingShift || platform.consts.defaultValues.adaptiveLightingShift
    this.transitionTime = deviceConf.transitionTime || platform.consts.defaultValues.transitionTime
    ...
    const opts = JSON.stringify({
      ...
      enableColour: this.enableColour,
  ...
  async requestDeviceUpdate () {
    try {
      ...
      if (caps[this.linkCodes.color] && this.hasColourSupport && this.enableColour) {
