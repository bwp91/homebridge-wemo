    ...
    try {
      ...
      const req = http.request(options, res => {
        if (res.statusCode === 200) {
          ...
          this.subInterval = setTimeout(() => this.subscribe(serviceType), 120000)
        } else {
          ...
          this.subInterval = setTimeout(() => this.subscribe(serviceType), 2000)
        }
      })
